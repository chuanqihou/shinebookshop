...
import com.shine.bookshop.bean.*;
...
public class BookDaoImpl implements BookDao {
	...
	public boolean bookDelById(int bookId) {
		...
		String sql3 = "delete from s_orderitem where bookId=?";
		DbUtil.excuteUpdate(sql3, bookId);
	...
	public boolean bookBatDelById(String ids) {
		String sql3 = "delete from s_orderitem where bookId in("+ids+")";
		DbUtil.excuteUpdate(sql3);
